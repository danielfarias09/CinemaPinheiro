...
public class ListFilmeSo extends Fragment {
    ...
    public void getFilmes(){
        ...
        Tarefa tarefa = new Tarefa(getContext(),cartaz,nome,horario,listView,
                "http://www.obomvizinho.com.br/cinemas/cinema-sobral");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_list_filme_so, container, false);
