...
public class ListFilmeLn extends Fragment {
    ...
    public void getFilmes(){
        ...
        Tarefa tarefa = new Tarefa(getContext(),cartaz,nome,horario,listView,
                "http://www.obomvizinho.com.br/cinemas/cinema-limoeiro-do-norte");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_list_filme_ln, container, false);
